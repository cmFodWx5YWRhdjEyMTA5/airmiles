...
echo "<script>window.location.href='http://doodle.meritincentives.com/thankyou.html'</script>";

  	}else{
  				
echo "<script>window.location.href='http://doodle.meritincentives.com/error.html'</script>";
  	}
	?>	
