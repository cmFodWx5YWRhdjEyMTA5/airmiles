...
echo "<script>window.location.href='https://oab.doodledigital.com/thankyou.html'</script>";
 
  	}else{
echo "<script>window.location.href='https://oab.doodledigital.com/error.html'</script>";
  	}
	?>	
