...
<div class="text-left col-md-6"><h1 class="box-title">Admin</h1></div>
</div>
<div class="box-body">
<div class="box-body">
<div class="row">
...
<div class="modal-header">
<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
<h4 class="modal-title" id="deletereferralsModalLabel">Delete Admin</h4>
</div>
<div class="modal-body">
...
<script src="dist/js/adminscript.js"></script>
