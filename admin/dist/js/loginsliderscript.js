jQuery(document).ready(function ($) {
    var clients_list_table = jQuery('#clients_list_table').DataTable({
        ...
        "order": [[1, 'asc']],
        "sAjaxSource": "process/loginsliderprocess.php",
    ...
    jQuery(document).on('click','.edit_Clients',function(e){
        ...
        jQuery.ajax({
            url: 'process/loginsliderprocess.php',
            type: 'POST',
            dataType: 'json',
            ...
            success: function(response) {
                ...
                document.getElementById("logoimageuploaded").src="../img/loginslider/"+response.image;
    ...
    jQuery('#add_client_form').submit(function(event){
        ...
        jQuery.ajax({
            url: 'process/loginsliderprocess.php?action=create_Clients',
            type: 'POST',
            dataType: 'json',
    ...
    jQuery('#edit_referrals_form').submit(function(event){
       ...
       jQuery.ajax({
            url: 'process/loginsliderprocess.php?action=update_Clients',
            type: 'POST',
            dataType: 'json',
            data: new FormData(this),     
            contentType: false,
