jQuery(document).ready(function ($) {
    var clients_list_table = jQuery('#clients_list_table').DataTable({
        ...
        "order": [[1, 'asc']],
        "sAjaxSource": "process/oabcardprocess.php",
...
jQuery(document).on('click','.add_client',function(e){
    ...
    jQuery(document).on('click','.edit_Clients',function(e){
        ...
        jQuery.ajax({
            url: 'process/oabcardprocess.php',
            type: 'POST',
            dataType: 'json',
...
jQuery(document).on('click','.markisreply1',function(e){
    ...
    jQuery('#add_client_form').submit(function(event){
        ...
        jQuery.ajax({
            url: 'process/oabcardprocess.php?action=create_Clients',
            type: 'POST',
            dataType: 'json',
    ...
    jQuery('#edit_referrals_form').submit(function(event){
       ...
       jQuery.ajax({
            url: 'process/oabcardprocess.php?action=update_Clients',
            type: 'POST',
            dataType: 'json',
            data: new FormData(this),     
            contentType: false,
...
jQuery(document).on('click','.view_questions',function(e){
    ...
    jQuery.ajax({
            url: 'process/oabcardprocess.phpp',
            type: 'POST',
            dataType: 'json',
            data: {
