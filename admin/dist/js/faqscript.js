jQuery(document).ready(function ($) {
    var clients_list_table = jQuery('#clients_list_table').DataTable({
        ...
        "order": [[1, 'asc']],
        "sAjaxSource": "process/faqprocess.php",
...
jQuery(document).on('click','.add_client',function(e){
    ...
    jQuery(document).on('click','.edit_Clients',function(e){
        ...
        jQuery.ajax({
            ...
            success: function(response) {
                ...
                jQuery('#EditreferralsModal #question').val(response.question);
                jQuery('#EditreferralsModal #questionarabic').val(response.questionarabic);
                jQuery('#EditreferralsModal #answer').val(response.answer);
                jQuery('#EditreferralsModal #answerarabic').val(response.answerarabic);
    ...
    jQuery('#add_client_form').submit(function(event){
        ...
        jQuery.ajax({
            url: 'process/faqprocess.php?action=create_Clients',
            type: 'POST',
            dataType: 'json',
    ...
    jQuery('#edit_referrals_form').submit(function(event){
       ...
       jQuery.ajax({
            url: 'process/faqprocess.php?action=update_Clients',
            type: 'POST',
            dataType: 'json',
            data: new FormData(this),     
            contentType: false,
