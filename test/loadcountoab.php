...
$pid = $_POST['pid'];
$oabq = Run("Select * from paymenthistory where productid = '".$pid."' and isoab='1'  and cardactive='1'");	
...
/////Created date////
$crr = "Select * from paymenthistory where productid = '".$pid."' and isoab='1'  and cardactive='1' and userid = '".$userid."'";
$oabq1 = Run($crr);	
