...
error_reporting(E_ALL);
	...
	try {
			...
			$currency	= $currencycode;
 			...
 			$errorURL	= "https://gifticms.meritincentives.com/oabpayment/bankHosted/HostedPaymentError.php";
				$resourcePath = "/home1/phutwamy/public_html/oab.doodledigital.com/oabpayment/cgnFiles/24/";
			if($isoab == "1"){
			$aliasName = "GIFTIOAB";	
			$receiptURL	= "https://gifticms.meritincentives.com/oabpayment/bankHosted/HostedPaymentResult.php";
			}
			else{
					$aliasName = "GIFTI2019";
					$receiptURL	= "https://gifticms.meritincentives.com/oabpayment/bankHosted/HostedPaymentResultnonoab.php";
			}
